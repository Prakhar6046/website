...
export const ContentToImageVerticalScrollBlock: Block = {
  slug: 'contentVerticalScrollBlock',
  interfaceName: 'ContentToImageVerticalScrollBlock',
  labels: {
    singular: 'Content Vertical Scroll Block',
    plural: 'Content Vertical Scroll Blocks',
  },
  fields: [
    {
      name: 'content',
